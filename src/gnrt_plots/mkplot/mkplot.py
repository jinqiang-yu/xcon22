...
def usage():
    ...
    print('        --ms=<float>                    Markersize, for cactus plots only (default = 5.0)')
    ...
    print('        -w, --width=<float>               Line width of cactus plots only (default = 1.0)')
